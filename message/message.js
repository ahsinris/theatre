class Message {
  ...
  105 = 'this movie doesnot exist';

  106 = 'this movie_slot doesnot exist';

  107 = 'kindly choose lesser quantity';

  108 = 'this movie doesnot run on this slot';
  ...
  121 = 'booking id not found';

  122 = ' already payment done';

  123 = 'failed to fetch all user details';

  124 = 'failed to fetch user details';

  125 = 'error in finding theaters for the given location';

  126 = 'no theater is available in given location';

  127 = 'no theater found for the given theater id';
  ...
  202 = 'movie details added sucessfully';

  203 = 'movie details fetched sucessfully';

  204 = 'movie booked details ';
  ...
  217 = 'all user details fetched sucessfully';

  218 = 'user details fetched sucessfully';

  219 = 'theater details fetched sucessfully for given location ';
